...
test('Handle onFocusChange', () => {
    const focusCalendar = 'endDate'
    wrapper.find('DateRangePicker').prop('onFocusChange')(focusCalendar)
    expect(wrapper.state('focusCalendar')).toBe(focusCalendar)
})